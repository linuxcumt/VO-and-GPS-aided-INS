...
for ntests = 1:100
    ...
    for i = 1:nx
        ...
        xp(i) = xp(i) + dx;
        xm(i) = xm(i) - dx;
        zpkp1 = measurement_model_INS( xp, wk );
        zmkp1 = measurement_model_INS( xm, wk );
        H_num(:,i) = (zpkp1 - zmkp1) / (2*dx);
    end

    % Measurement Model
    [z, H] = measurement_model_INS( xk, wk );
...
%% Output
fprintf('PASSED: Test_measurement_model_INS\n');