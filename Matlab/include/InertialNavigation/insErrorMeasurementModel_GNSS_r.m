function [ zk, Hk ] = insErrorMeasurementModel_GNSS_r( xk, wk )
% Measurement model for GNSS Position only error components
...
% 
% OUTPUTS
% zk - 3 x 1 double vector
%      State vector at time k
% Hk - 3 x 21 double matrix
