function [ xhatkp1, Pkp1, Wkp1, epsilonkp1, xbarkp1, Pbarkp1 ] ...
    = kalmaniter_unscented( kfdata )
% Computes one iteration of the Sigma Points Kalman Filter
...
% the estimate xhat(k+1). This is the implementation of the Sigma Points
% Kalman Filter.
% 
% This function performs the Unscented Kalman Filter state estimate for the
...
%              A complete list of the required 12 data fields follows:
%              - k     - int
...
assert(size(fieldnames(kfdata), 1) == 12, ...
...
% Compute A Priori covariance and cross correlation weights
...
% Compute A Priori covariances and cross correlation
